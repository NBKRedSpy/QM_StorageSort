...
namespace StorageSort.Utils
{
    ...
    public abstract class UpdateComponent<T> : MonoBehaviour where T : MonoBehaviour, new()
    {
        ...
        /// </summary>
        protected static string InternalComponentId { get; set; } = $"Unknown UpdateComponent<{typeof(T).Name}>";

        public string GetDefaultComponentId { get; protected set; } =  InternalComponentId;
